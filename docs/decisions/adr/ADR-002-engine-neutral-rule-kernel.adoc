...
adapter. The initial opt-in count-plan kernel is implemented in `dq.plan`; native
Spark/DataFusion compilers and legacy configuration translation remain planned.
Adoption of the broader architecture remains proposed until adapter parity is demonstrated.
