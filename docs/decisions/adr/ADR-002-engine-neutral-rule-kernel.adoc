...
adapter. Kernel implementation and native Spark/DataFusion compilers remain planned.
...
|PyDeequ; native Spark planned
|Shared empty/null/NaN/decimal fixtures and one-scan plan checks
...
* https://github.com/awslabs/deequ[Deequ analyzers and Spark execution]
* https://github.com/awslabs/python-deequ/releases/tag/v1.7.0[PyDeequ 1.7 changes]
* https://docs.greatexpectations.io/docs/core/introduction/[Great Expectations validation concepts]
* https://arrow.apache.org/docs/format/Columnar.html[Arrow memory and interchange format]
* https://datafusion.apache.org/user-guide/introduction.html[DataFusion query engine and Arrow integration]
